...
Expected output for lrthw_ex1.rb file after doing the extras listed below:
  ...
  Add a final line to the script explaining what an octothorpe is and what it does in Ruby.
...
Expected output for lrthw_ex2.rb file when run from the command line is:
